    ...
    <main className="min-h-screen bg-gradient-to-br from-white to-slate-50 flex items-center justify-center px-6 py-12">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-light text-slate-900 mb-2">Welcome Back</h1>
        ...
        <motion.form onSubmit={handleSubmit} variants={itemVariants} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-xs font-light text-slate-700">Password</label>
              <Link href="#" className="text-xs text-emerald-600 hover:text-emerald-700 font-light transition-colors">
                Forgot password?
              </Link>
            </div>
        ...
        <motion.p variants={itemVariants} className="text-center mt-6 text-sm text-slate-600 font-light">
          ...
          <Link href="/auth/signup" className="text-emerald-600 hover:text-emerald-700 font-normal transition-colors">
            Sign Up
          </Link>
        </motion.p>
      </motion.div>
